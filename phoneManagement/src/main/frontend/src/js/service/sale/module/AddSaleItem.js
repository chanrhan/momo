...
export function AddSaleItem({name, subject, children, errorText, error, style}){
    return (
        <li className={cm(Popup.customer_item, `${(error || errorText) && cmc(Popup.error)}`)} style={style}>
            {children}
