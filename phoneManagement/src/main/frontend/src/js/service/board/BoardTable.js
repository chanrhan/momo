...
export function BoardTable({caption, colgroup, children, tableRef, style, onScroll, className}){
    return (
        <div className={`board_body ${Board.sticky} ${className}`} style={style} onScroll={onScroll}>
